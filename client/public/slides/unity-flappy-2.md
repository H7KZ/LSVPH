...
![Pipe prefab — hierarchie v Hierarchy okně](/images/flappy/pipe-prefab.png)
...
![Pipe komponenty v Inspektoru (tag: Pipe)](/images/flappy/pipe-inspector.png)
...
![PipeDestroy objekt vlevo od kamery ve Scene](/images/flappy/pipedestroy.png)
...
![PipeSpawner — pole v Inspektoru + prefab](/images/flappy/spawner-inspector.png)
...
![Canvas + ScoreText v Hierarchy](/images/flappy/canvas.png)
...
![GameManager — Score Text v Inspektoru](/images/flappy/gamemanager-inspector.png)

- **Score Text:** přetáhni `ScoreText` (TextMeshProUGUI) z Hierarchy

Notes:
SerializeField = drag & drop v Inspektoru. Chybí reference → NullReferenceException v Console. Zkontrolujte Console po
spuštění.
...
![Hotová hra v Play Mode](/images/flappy/final-game.png)
