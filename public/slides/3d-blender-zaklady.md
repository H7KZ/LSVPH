...
*Příklad:* Zápis `G` → `Z` posune kostku přesně kolmo nahoru.
...
*TIP: Zkratka: Podržením klávesy **Z** vyvoláte rychlé kruhové menu pro přepínání těchto režimů.*
...
*Další: Vstup do Edit Módu – jak otevřít model a měnit samotný tvar objektů.*